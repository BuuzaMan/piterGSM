...
const Header = () => {
  return (
    <div className='flex flex-col desktopxl:w-[1920px] desktopmd:w-[1600px] desktopsm:w-[1360px] tablet:w-[1200px] tabletsm:w-[1024px] mobilexl:w-[768px] mobilemd:w-[480px] mobilesm:w-[360px] desktopxl:h-[658px] desktopmd:h-[642px] desktopsm:h-[642px] tablet:h-[642px] tabletsm:h-[555px] mobilexl:h-[496px] mobilemd:h-[790px] mobilesm:h-[595px] relative overflow-hidden'>
        ...
        <div className='desktopxl:w-[831px] desktopmd:w-[831px] desktopsm:w-[644px] tablet:w-[635px] tabletsm:w-[550px] mobilexl:w-[490px] mobilemd:w-[400px] mobilesm:w-[320px] desktopxl:h-[135px] desktopmd:h-[135px] desktopsm:h-[123px] tablet:h-[123px] tabletsm:h-[96px] mobilexl:h-[81px] mobilemd:h-[144px] mobilesm:h-[108px] font-unbounded font-bold desktopxl:text-[40px] desktopmd:text-[40px] desktopsm:text-[36px] tablet:text-[36px] tabletsm:text-[28px] mobilexl:text-[24px] mobilemd:text-[32px] mobilesm:text-[24px] desktopxl:leading-[3rem] desktopmd:leading-[3rem] desktopsm:leading-[3rem] tablet:leading-[3rem] tabletsm:leading-[2rem] mobilexl:leading-[1.5rem] mobilemd:leading-[2rem] mobilesm:leading-[1.7rem] uppercase desktopxl:mt-[112.5px] desktopmd:mt-[112.5px] desktopsm:mt-[112.5px] tablet:mt-[67px] tabletsm:mt-[67.5px] mobilexl:mt-[67.5px] mobilemd:mt-[280px] mobilesm:mt-[182px] desktopxl:ml-[80px] desktopmd:ml-[80px] desktopsm:ml-[80px] tablet:ml-[40px] tabletsm:ml-[40px] mobilexl:ml-[40px] mobilemd:ml-[20px] mobilesm:ml-[20px] z-10'>
            Оставьте заявку на ремонт, или проверьте статус вашего заказа
        </div>
        <div className='deskopxl:w-[490px] desktopmd:w-[420px] desktopsm:w-[476px] tablet:w-[476px] tabletsm:w-[476px] mobilexl:w-[476px] mobilemd:w-[400px] mobilesm:w-[285px] desktopxl:h-[72px] desktopmd:h-[72px] desktopsm:h-[72px] tablet:h-[72px] tabletsm:h-[72px] mobilexl:h-[72px] mobilemd:h-[96px] mobilesm:h-[76px] font-golos font-medium desktopxl:text-[16px] desktopmd:text-[16px] desktopsm:text-[16px] tablet:text-[16px] tabletsm:text-[14px] mobilexl:text-[14px] mobilemd:text-[16px] mobilesm:text-[13px] -tracking-[.075em] mt-[24px] desktopxl:ml-[80px] desktopmd:ml-[80px] desktopsm:ml-[80px] tablet:ml-[40px] tabletsm:ml-[40px] mobilexl:ml-[40px] mobilemd:ml-[20px] mobilesm:ml-[20px] z-10'>
            Теперь Вы можете по номеру квитанции и паролю проверить состояние Вашего заказа, ознакомится с условиями и ценами ремонта и выразить согласие на выполнение работ
        </div>
